...
function loadlevel () {
    if (level == 1) {
        ...
        for (let value of tiles.getTilesByType(assets.tile`myTile`)) {
            level_one_enemy = sprites.create(img`
                .....fffffffff......
                ....fffffffffff.....
                ...ffffffff2ffff....
                ..ffffffff22fffff...
        ...
        if (level == 2) {
            ...
            for (let value of tiles.getTilesByType(assets.tile`myTile1`)) {
                level_2_enemy = sprites.create(img`
                    ..................fffffffff.............
                    .......fffffffffffffffffffff.fff........
                    ..........f....ffffffffffffff...........
                    ....222......ffffffffffffffff...........
                    ....2.2.....ff22222222222ffff...........
                    ....222...ff221111111111122ff......222..
                    ..........2211111111111111122......222..
                    .........211111111111111111112.....222..
                    ........21111111111111111111112.........
                    .......2111111111111111111111112........
                    ......21111fffff11111111111111112.......
                    ......21111fffff111111111fffff112.......
                    .....211111f1f1f11111111fffffff112......
                    .....211111f111f11111111fffffff112......
                    ....2111111fffff11111111fffffff1112.....
                    ....21111111111111111111f11f11f1112.....
                    ....21111111111111111f11f11111f1112.....
                    ....211111111111111111111fffff11112.....
                    ....2111111111111111111111111111112.....
                    ....21111111111111fffff111111111112.....
                    ....2111111111111fffffff11111111112.....
                    ....2111111111111f11111f11111111112.....
                    ....2111111111111fffffff11111111112.....
                    ....2111111111111f11ff1f11111111112.....
                    ....2111111111111f11ff1f11111111112.....
                    .....2111111111111fffff11111111112......
                    .....21111111111111111111111111112......
                    ......211111111111111111111111112.......
                    ......211111111111111111111111112.......
                    .......2111111111111111111111112........
                    ........21111111111111111111112....222..
                    .........211111111111111111112.....222..
                    ..........2211111111111111122......222..
                    ............221111111111122.............
                    ..............22222222222...............
                    ...
                    ........................................
                    `, SpriteKind.Enemy)
                tiles.placeOnTile(level_2_enemy, value)
                level_2_enemy.follow(GERM_FIGHTER, 50)
                tiles.setTileAt(value, assets.tile`transparency16`)
            }
        }
    }
...
browserEvents.E.onEvent(browserEvents.KeyEvent.Pressed, function () {
    if (shoot_direction == 1) {
        Basic_attack = sprites.createProjectileFromSprite(img`
            . f f f f f 2 . . . . . . . . . 
            . . . . . f f 2 . . . . . . . . 
            . . . . . . f f 2 . . . . . . . 
            . . . . . . . f f 2 . . . . . . 
...
let level_2_enemy: Sprite = null
let level_one_enemy: Sprite = null
let GERM_FIGHTER: Sprite = null
let shoot_direction = 0
let level = 0
level = 1
shoot_direction = 1
GERM_FIGHTER = sprites.create(img`
    . . . . . . f f f f . . . . . . 
    . . . . f f f 2 2 f f f . . . . 
    . . . f f f 2 2 2 2 f f f . . . 
